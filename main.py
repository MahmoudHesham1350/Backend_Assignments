...
class Interface:
    ...
    def add_book(self):
        ...
        """
        title = Validation.get_valid_string("Enter title: ")
        author = Validation.get_valid_string("Enter author: ")
        publication_date = Validation.get_valid_date("Enter publication date (YYYY-MM-DD): ")
        isBorrowed = False
        book = Book(title, author, publication_date, isBorrowed)
